<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:93:"D:\huanjing\phpStudy\PHPTutorial\WWW\demo\public/../application/admin\view\product\index.html";i:1534154490;s:81:"D:\huanjing\phpStudy\PHPTutorial\WWW\demo\application\admin\view\public\head.html";i:1534757953;s:83:"D:\huanjing\phpStudy\PHPTutorial\WWW\demo\application\admin\view\public\header.html";i:1531461965;s:81:"D:\huanjing\phpStudy\PHPTutorial\WWW\demo\application\admin\view\public\left.html";i:1534208797;s:81:"D:\huanjing\phpStudy\PHPTutorial\WWW\demo\application\admin\view\public\foot.html";i:1531447133;}*/ ?>
...
<script type="text/javascript">
    ...
    function del(id) {
        layer.confirm('确定要删除吗？',  function(){
            window.location.href="/admin/Product/del?id="+id;
        });
    }
</script>
<div id="dcMain"><!-- 当前位置 -->
    <div id="urHere">管理中心<b>></b><strong>产品展示</strong> </div>   <div id="manager" class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
    <h3>
      <a href="/admin/Product/add"  class="actionBtn">添加产品</a>
        产品列表
    </h3>
     ...
     <tr>
      ...
      <td align="center">
        <a href="<?php echo url('Product/edit'); ?>?id=<?php echo $list->id; ?>">编辑</a> |
